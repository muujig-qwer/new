...
const CATEGORY_ID = "685bc3f4047b999fc7f191b5"; // travel category-ийн id
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 flex gap-8">
      ...
      <aside className="w-56 shrink-0">
        <div className="bg-white rounded-xl shadow p-4 sticky top-8">
          <h2 className="text-lg font-bold mb-4">Аяллын дэд ангилал</h2>
      ...
      <main className="flex-1">
        <h1 className="text-2xl font-bold mb-6">Аялал</h1>
