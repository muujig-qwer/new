...
const CATEGORY_ID = "685d04b20dc9f10b84805fb1"; // Спорт category-ийн id
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 flex gap-8">
      ...
      <aside className="w-56 shrink-0">
        <div className="bg-white rounded-xl shadow p-4 sticky top-8">
          <h2 className="text-lg font-bold mb-4">Спорт дэд ангилал</h2>
      ...
      <main className="flex-1">
        <h1 className="text-2xl font-bold mb-6">Спорт</h1>
